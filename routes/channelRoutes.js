...
router.post("/create-channel", uploadFiles, ChannelController.createController);

router.post("/search-channel", ChannelController.showSearchedChannelsController);
...
router.patch("/:channelId/edit", uploadFiles, ChannelController.updateController);
